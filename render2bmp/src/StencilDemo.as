...
import com.adobe.utils.AGALMiniAssembler;
    ...
    public class StencilDemo extends Sprite
    {
        ...
        private var stateTimer:Timer = new Timer( 2250 );
        ...
        private function non3DSetup():void
        {
			...
			this.stage.addEventListener( MouseEvent.CLICK, function(event:Event):void { doState(null); } );
